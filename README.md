...
> 🚧 **Projet en construction.** Rien n'est figé : tout reste à créer. Ce
> document décrit **l'intention** — la direction qu'on se donne — pas encore
> la mise en œuvre.
...
recueille, comprend, relie et range — viendra ensuite, pièce par pièce.
